...
% matlabbatch{1}.spm.dcm.peb.specify.cov.regressor(2).name = 'gender';
% gender = sex-1;
% matlabbatch{1}.spm.dcm.peb.specify.cov.regressor(2).value = gender;
% matlabbatch{1}.spm.dcm.peb.specify.cov.regressor(3).name = 'scanner';
% scnr = scanner-1;
% matlabbatch{1}.spm.dcm.peb.specify.cov.regressor(3).value = scnr;
